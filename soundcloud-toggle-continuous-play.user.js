...
(function() {
	...
	var App = {
		...
		isPlaying: function(e) {
			if (this.playButton && this.playButton.classList.contains('playing')) {
				return true;
			}
			return false;
		},
	...
	var obs = new MutationObserver(function() {
		setTimeout(function() {
			...
			if (!autoplayControl.checked && next !== current) {
				App.pause();
			}
			current = next;
		}, 0);
	...
	waitForElems('.skipControl, .playButton, .waveform__layer', function(elem) {
